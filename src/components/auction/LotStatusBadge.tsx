...
const statusConfig: Record<LotStatus, { label: string; variant: "default" | "secondary" | "destructive" | "outline" | "success" | "warning" }> = {
  ...
  reserve_not_met: { label: "Reserve Not Met", variant: "secondary" },
