...
// Sample data only. Names are intentionally generic archetypes
// describing scenario + neighborhood, never realistic personal names.
const referrals: Referral[] = [
  { id: "REF-024", date: "2026-04-15", clientName: "Sample Family Estate (Westside)", status: "submitted" },
  { id: "REF-023", date: "2026-04-12", clientName: "Sample Family Trust", status: "contacted", jobValue: "$38,000" },
  { id: "REF-022", date: "2026-04-08", clientName: "Sample Probate Estate", status: "converted", jobValue: "$52,400", fee: "$262" },
  { id: "REF-021", date: "2026-04-02", clientName: "Sample Downsizing Engagement", status: "paid", jobValue: "$28,700", fee: "$144", paidDate: "2026-04-15" },
  { id: "REF-020", date: "2026-03-28", clientName: "Sample Estate Collection", status: "paid", jobValue: "$64,200", fee: "$321", paidDate: "2026-04-15" },
  { id: "REF-019", date: "2026-03-22", clientName: "Sample Senior Move", status: "paid", jobValue: "$18,300", fee: "$92", paidDate: "2026-03-31" },
  { id: "REF-018", date: "2026-03-15", clientName: "Sample Probate Engagement", status: "paid", jobValue: "$42,100", fee: "$211", paidDate: "2026-03-31" },
  { id: "REF-017", date: "2026-03-10", clientName: "Sample Storage Unit Clearance", status: "converted", jobValue: "$8,500", fee: "$43" },
  { id: "REF-016", date: "2026-03-05", clientName: "Sample Trust Estate", status: "paid", jobValue: "$95,800", fee: "$479", paidDate: "2026-03-31" },
  { id: "REF-015", date: "2026-02-28", clientName: "Sample Engagement (Out-of-scope)", status: "rejected" },
  { id: "REF-014", date: "2026-02-20", clientName: "Sample Manor Clearance", status: "paid", jobValue: "$72,600", fee: "$363", paidDate: "2026-02-28" },
  { id: "REF-013", date: "2026-02-14", clientName: "Sample Antiques Collection", status: "paid", jobValue: "$128,400", fee: "$642", paidDate: "2026-02-28" },
  { id: "REF-012", date: "2026-02-08", clientName: "Sample Family Trust (Hillside)", status: "paid", jobValue: "$34,900", fee: "$175", paidDate: "2026-02-28" },
  { id: "REF-011", date: "2026-02-01", clientName: "Sample Estate Sale", status: "paid", jobValue: "$22,800", fee: "$114", paidDate: "2026-02-28" },
  { id: "REF-010", date: "2026-01-25", clientName: "Sample Condo Contents (Out-of-scope)", status: "rejected" },
  { id: "REF-009", date: "2026-01-18", clientName: "Sample Antiques Engagement", status: "paid", jobValue: "$56,200", fee: "$281", paidDate: "2026-01-31" },
  { id: "REF-008", date: "2026-01-12", clientName: "Sample Storage Clean-out", status: "paid", jobValue: "$12,400", fee: "$62", paidDate: "2026-01-31" },
  { id: "REF-007", date: "2026-01-05", clientName: "Sample Estate Liquidation", status: "paid", jobValue: "$88,700", fee: "$444", paidDate: "2026-01-31" },
  { id: "REF-006", date: "2025-12-20", clientName: "Sample Family Downsizing", status: "paid", jobValue: "$19,600", fee: "$98", paidDate: "2025-12-31" },
  { id: "REF-005", date: "2025-12-14", clientName: "Sample Farm Contents", status: "paid", jobValue: "$45,300", fee: "$227", paidDate: "2025-12-31" },
  { id: "REF-004", date: "2025-12-05", clientName: "Sample Art Collection (Out-of-scope)", status: "rejected" },
  { id: "REF-003", date: "2025-11-28", clientName: "Sample Condo Clean-out", status: "paid", jobValue: "$7,800", fee: "$39", paidDate: "2025-11-30" },
  { id: "REF-002", date: "2025-11-15", clientName: "Sample Estate Liquidation (Larger)", status: "paid", jobValue: "$62,500", fee: "$313", paidDate: "2025-11-30" },
  { id: "REF-001", date: "2025-08-20", clientName: "Sample Manor Clearance (Historical)", status: "paid", jobValue: "$110,200", fee: "$551", paidDate: "2025-08-31" },
];
