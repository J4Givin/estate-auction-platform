  ...
  return (
    <PublicShell>
      ...
      <Section className="bg-[#F6F1E8]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 mt-12 border-t border-[#E5DECF]">
          {[
            ...
            <div key={x.t} className="border-b border-[#E5DECF] md:border-r last:border-r-0 px-0 md:px-8 py-10">
        ...
        <p className="label text-[#706A60] mt-10 max-w-3xl leading-relaxed">
